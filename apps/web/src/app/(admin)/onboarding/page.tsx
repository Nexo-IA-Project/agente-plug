...
function OnboardingContent() {
  ...
  function openEdit(flow: OnboardingFlow) {
    setEditingFlow(flow);
    setDrawerOpen(true);
  }
  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center justify-between border-b border-outline-variant/40 px-8 py-5">
        <div>
          <h1 className="text-headline-sm font-bold text-on-surface">Onboarding Flows</h1>
          ...
          <div className="flex h-full flex-col items-center justify-center gap-4 text-center">
            ...
            <div>
              ...
              <p className="mt-1 text-body-sm text-on-surface-variant">
                Crie seu primeiro flow de onboarding para começar a engajar clientes
              </p>
            </div>
            <button
              onClick={openCreate}
