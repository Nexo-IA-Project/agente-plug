...
import { MessageBufferSection } from "@/features/settings/components/MessageBufferSection";
import { RequirePermission } from "@/features/auth/components/RequirePermission";
import type { AccountSettings } from "@/features/settings/types";

export default function MessageBufferSettingsPage() {
    ...
    <RequirePermission perm="settings.view">
      {error ? (
        ...
        <div className="space-y-8 p-6">
          ...
          <MessageBufferSection initial={settings} onSaved={setSettings} />
        </div>
      )}
    </RequirePermission>
  );
