...
export function SyncSummaryView({ summary }: Props) {
  const { templates_to_delete, templates_to_insert, steps_to_delete } = summary;

  return (
    <div className="space-y-3">
      <p>
        Vamos puxar o estado atual dos templates direto da Meta e atualizar o banco
        local. Isso resolve casos onde o <code>parameter_format</code> está
        desatualizado (causa do erro #132012).
      </p>
